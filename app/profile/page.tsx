              ...
              <div className="space-y-4">
                <div>
                  ...
                  <input
                    ...
                    className="w-full px-4 py-2.5 rounded-xl text-sm text-white placeholder-white/40 border border-white/15 focus:border-gold/50 focus:outline-none"
                  />
                </div>
                ...
                <div>
                  ...
                  <input
                    ...
                    value={staff?.email || ''}
                    disabled
                    style={{ backgroundColor: '#060B18', color: '#ffffff' }}
                    className="w-full px-4 py-2.5 rounded-xl text-sm text-white/40 border border-white/10 cursor-not-allowed"
                  />
                ...
                <div>
                  ...
                  <div className="relative">
                    <input
                      ...
                      style={{ backgroundColor: '#091124', color: '#ffffff' }}
                      className="w-full px-4 py-2.5 pr-10 rounded-xl text-sm text-white placeholder-white/40 border border-white/15 focus:border-gold/50 focus:outline-none"
                    />
