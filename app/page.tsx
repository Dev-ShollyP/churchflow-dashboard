...
import { Users, MessageSquare, Heart, Calendar, TrendingUp, Clock, ArrowRight, Sparkles, UploadCloud, MessageCircle, UserCheck } from 'lucide-react';
    ...
    <DashboardShell>
      ...
      <div className="glass-card p-6 md:p-8 mb-8 relative overflow-hidden"
        ...
        <div className="relative z-10 flex flex-col md:flex-row md:items-center justify-between gap-6">
          <div>
            <div className="inline-flex items-center gap-2 px-3 py-1 rounded-full bg-gold/10 border border-gold/20 text-gold text-xs font-semibold mb-3">
              <Sparkles size={12} />
            ...
            <p className="text-xs md:text-sm text-white/50 mt-1">
              {todayStr} • Here is your live WhatsApp & Church management activity.
            </p>
          </div>
          ...
          <div className="flex items-center gap-3 flex-wrap">
            <Link
              href="/events/upload"
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-semibold btn-gold shadow-gold"
            >
              <UploadCloud size={15} />
            ...
            <Link
              href="/conversations"
              className="flex items-center gap-2 px-4 py-2.5 rounded-xl text-xs font-medium btn-glass"
            >
              ...
              data.recentConversations.map((conv: any) => {
                ...
                return (
                  <Link
                    ...
                    className="flex items-center gap-3 px-6 py-3.5 table-row-hover group transition-colors block"
                  >
                    ...
                    <div className="flex-1 min-w-0">
                      ...
                      <p className="text-xs text-white/35 truncate">{member?.phone}</p>
                    </div>
          ...
          <div className="divide-y divide-white/5">
            {loading ? (
              ...
              data.upcomingEvents.map((event: any) => (
                <div key={event.id} className="flex items-center gap-4 px-6 py-3.5 table-row-hover">
