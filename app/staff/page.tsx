...
import { UserCheck, Shield, Trash2, Edit3, Plus, AlertCircle, CheckCircle2, UserPlus, Lock, CheckSquare, Square, Eye, EyeOff } from 'lucide-react';
...
export default function StaffManagementPage() {
  ...
  // Set Password for existing staff
    ...
    <DashboardShell>
                  ...
                  <div key={member.id} className="p-4 flex items-center justify-between gap-4 table-row-hover">
                    ...
                    <div className="flex items-center gap-2">
                      ...
                      <button
                        ...
                        className="p-2 rounded-lg text-xs text-white/40 hover:text-yellow-300 hover:bg-yellow-500/10 border border-white/10 transition-colors"
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2 pr-10 rounded-xl text-sm text-white placeholder-white/20 bg-navy-dark/60 border border-white/10 focus:border-gold/50 focus:outline-none"
                />
                <button
                  type="button"
              ...
              <p className="text-[10px] text-white/30 mt-1">Share this password with the staff member — they'll use it to sign in.</p>
            </div>
      ...
      {editingStaff && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="glass-card max-w-lg w-full max-h-[90vh] overflow-y-auto p-4 sm:p-6 space-y-5 animate-slide-up border border-gold/30">
      ...
      {setPasswordTarget && (
        <div className="fixed inset-0 z-50 flex items-center justify-center bg-black/70 backdrop-blur-sm p-4">
          <div className="glass-card max-w-sm w-full p-6 space-y-5 animate-slide-up border border-yellow-500/30">
            <div className="border-b border-white/10 pb-4">
              <h3 className="font-display font-semibold text-white text-lg flex items-center gap-2">
                <Lock size={18} className="text-yellow-400" /> Set Login Password
              </h3>
              <p className="text-xs text-white/40 mt-1">{setPasswordTarget.full_name || setPasswordTarget.email}</p>
              <p className="text-xs text-yellow-400/70 mt-1">{setPasswordTarget.email}</p>
            </div>
            ...
            <div>
              ...
              <div className="relative">
                <input
                  ...
                  className="w-full px-3.5 py-2.5 pr-10 rounded-xl text-sm text-white placeholder-white/20 bg-navy-dark/60 border border-white/10 focus:border-yellow-400/50 focus:outline-none"
                />
                <button
                  type="button"
              ...
              <p className="text-[10px] text-white/30 mt-1">Share this password with {setPasswordTarget.full_name || 'the staff member'} so they can sign in.</p>
            </div>
            ...
            <div className="flex items-center justify-end gap-3 pt-2">
              ...
              <button
                ...
                className="px-4 py-2 rounded-xl text-xs font-semibold text-navy-dark disabled:opacity-50"
