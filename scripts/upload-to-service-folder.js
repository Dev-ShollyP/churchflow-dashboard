...
async function uploadToServiceFolder() {
  ...
  const filePath = 'Service/Youth_Sunday_Mountains.jpg';

  console.log(`Uploading ${fileBuffer.length} bytes to Supabase Storage path "${filePath}"...`);
  ...
  if (res.status === 200) {
    console.log('🎉 200 OK SUCCESSFUL! Updating Youth Sunday in Supabase DB...');
