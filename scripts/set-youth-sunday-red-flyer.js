...
async function setYouthSundayRedFlyer() {
  ...
  console.log(`Read red "Mountains Be Removed" flyer image file. Size: ${fileBuffer.length} bytes.`);
  ...
  if (updateErr) {
    ...
    console.log('🎉 SUCCESS! Youth Sunday row in DB updated with the exact red "Mountains Be Removed" graphic Data URL!');
  }
}

setYouthSundayRedFlyer();
